...
BlueJelly.prototype.requestDevice = function(uuid) {
  ...
  return navigator.bluetooth.requestDevice({
      ...
      optionalServices: [this.hashUUID[uuid].serviceUUID, BlueJelly.MICROBIT_UART_SERVICE,
                                                          BlueJelly.MICROBIT_BUTTON_SERVICE,
                                                          BlueJelly.MICROBIT_TEMPERATURE_SERVICE]
      //optionalServices: [BlueJelly.MICROBIT_UART_SERVICE]
      //optionalServices: [BlueJelly.MICROBIT_BUTTON_SERVICE]
